...
public class property
{
    ...
    public static DataTable view()
    {
        ...
        SqlCommand cmd = new SqlCommand(@"
        		SELECT admin_registeration.dbo.client_info.name,admin_registeration.dbo.client_info.applicant_cnic,admin_registeration.dbo.property_info.*
FROM admin_registeration.dbo.property_info
INNER JOIN admin_registeration.dbo.client_info
ON admin_registeration.dbo.property_info.client_id=admin_registeration.dbo.client_info.Id
where admin_registeration.dbo.property_info.plot_no !=''", conn);
        conn.Open();
    ...
    public static bool updateMembership(string id, string name, string cnic, string relation, string address, string profession, string phone)
    {
        ...
        SqlCommand cmd = new SqlCommand();
        cmd.Connection = conn;
        //     cmd.CommandText = "UPDATE admin_registeration.dbo.property_info SET plot_no=@plot_no,plot_size=@plot_size, street_no=@street_no, plot_address= @plot_address, owner_property_name = @owner_property_name, owner_property_address =@owner_property_address,property_type=@property_type,owner_property_cnic=@owner_property_cnic WHERE Id='" + id + "'";


        cmd.CommandText = @"UPDATE admin_registeration.dbo.client_info SET name=@name, relation_of=@relation,applicant_cnic=@applicant_cnic,
    ...
    public static DataTable unpaidDownpaymentClient()
    {
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString);
        SqlCommand cmd = new SqlCommand(@"
        		SELECT admin_registeration.dbo.client_info.Id,admin_registeration.dbo.client_info.name,admin_registeration.dbo.client_info.applicant_cnic,admin_registeration.dbo.property_info.registrationo,admin_registeration.dbo.client_info.relation_of,admin_registeration.dbo.client_info.present_address,admin_registeration.dbo.client_info.occupation,admin_registeration.dbo.client_info.telephone,admin_registeration.dbo.payment.date
FROM admin_registeration.dbo.property_info
INNER JOIN admin_registeration.dbo.client_info
ON admin_registeration.dbo.property_info.client_id=admin_registeration.dbo.client_info.Id
INNER JOIN admin_registeration.dbo.payment
ON admin_registeration.dbo.payment.property_registration=admin_registeration.dbo.property_info.registrationo
where admin_registeration.dbo.property_info.plot_no='';", conn);
        conn.Open();
        SqlDataAdapter da = new SqlDataAdapter(cmd);
        DataTable dt = new DataTable();
    ...
    {
        string query = @"SELECT admin_registeration.dbo.client_info.Id,admin_registeration.dbo.client_info.name,admin_registeration.dbo.client_info.applicant_cnic,admin_registeration.dbo.property_info.registrationo,admin_registeration.dbo.client_info.relation_of,admin_registeration.dbo.client_info.present_address,admin_registeration.dbo.client_info.occupation,admin_registeration.dbo.client_info.telephone,admin_registeration.dbo.payment.date
FROM admin_registeration.dbo.property_info
INNER JOIN admin_registeration.dbo.client_info
ON admin_registeration.dbo.property_info.client_id=admin_registeration.dbo.client_info.Id
INNER JOIN admin_registeration.dbo.payment
ON admin_registeration.dbo.payment.property_registration=admin_registeration.dbo.property_info.registrationo
where (admin_registeration.dbo.property_info.plot_no='' and admin_registeration.dbo.client_info.applicant_cnic='"+searchstr+"') or (admin_registeration.dbo.property_info.plot_no='' and admin_registeration.dbo.property_info.registrationo='"+searchstr+"');";
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString);
    ...
    public static DataTable searchPropertyDetailByCnic(string cnic)
    {
        ...
        /*  SqlCommand cmd = new SqlCommand(@"
          SELECT *  
          FROM admin_registeration.dbo.property_info", conn);*/
        SqlCommand cmd = new SqlCommand(@"
        		SELECT *
FROM admin_registeration.dbo.property_info
INNER JOIN admin_registeration.dbo.client_info
ON admin_registeration.dbo.property_info.client_id=admin_registeration.dbo.client_info.Id
where admin_registeration.dbo.client_info.applicant_cnic='"+cnic+ "' or admin_registeration.dbo.property_info.registrationo='"+cnic+"';", conn);//cnic can be eithere regno or 
        conn.Open();
        SqlDataAdapter da = new SqlDataAdapter(cmd);
        DataTable dt = new DataTable();
        da.Fill(dt);
    ...
    public static bool deleteProperty(string id)
    {
        ...
        cmd.CommandText = "DELETE FROM admin_registeration.dbo.property_info WHERE id = @Id";
    ...
    {
        string query = "SELECT admin_registeration.dbo.client_info.name,admin_registeration.dbo.client_info.applicant_cnic,admin_registeration.dbo.property_info.*,admin_registeration.dbo.payment.payment_amount_in_Rs,admin_registeration.dbo.payment.date FROM admin_registeration.dbo.client_info INNER JOIN admin_registeration.dbo.property_info on admin_registeration.dbo.client_info.id = admin_registeration.dbo.property_info.client_id INNER JOIN admin_registeration.dbo.payment on admin_registeration.dbo.client_info.id = admin_registeration.dbo.payment.client_id; ";
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString);
        SqlCommand cmd = new SqlCommand(query, conn);
        conn.Open();
        SqlDataAdapter da = new SqlDataAdapter(cmd);

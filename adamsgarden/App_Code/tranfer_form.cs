...
inner join property_info on admin_registeration.dbo.property_info.client_id=admin_registeration.dbo.client_info.id
...
where admin_registeration.dbo.Transfer_form_information.applicant_cnic='" + cnic + "' AND admin_registeration.dbo.Transfer_form_information.type='buyer'";
        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString);
        con.Open();
        SqlCommand cmd = new SqlCommand(query, con);
        SqlDataAdapter sd = new SqlDataAdapter(cmd);
...
where admin_registeration.dbo.Transfer_form.buyer_id='" + bid + "' AND admin_registeration.dbo.Transfer_form.seller_id='"+sid+ "' AND admin_registeration.dbo.Transfer_form.regno='"+regno+"'";
        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString);
        con.Open();
        SqlCommand cmd = new SqlCommand(query, con);
        SqlDataAdapter sd = new SqlDataAdapter(cmd);
...
from payment
where payment.property_registration='" + regno+"'";
        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString);
        con.Open();
        SqlCommand cmd = new SqlCommand(query, con);
        SqlDataAdapter sd = new SqlDataAdapter(cmd);

...
public class advertisement
{
    ...
    public static bool insertAdvertisement(byte[] msdata, string status1)
    {
        ...
        SqlCommand cmd = new SqlCommand("insert into admin_registeration.dbo.advertisement values(@image,@slider_status,@content)", conn);
        conn.Open();
    ...
    public static bool updateAdvertisement(string id, byte[] msdata1, string stat)
    {
        ...
        cmd.Connection = conn;
        cmd.CommandText = "UPDATE admin_registeration.dbo.advertisement SET image = @fu,slider_status=@stat WHERE id = @id";
        // cmd.CommandText = "UPDATE admin_registeration.dbo.advertisement SET image = @fu,slider_status=@status WHERE id = @id";
    ...
    public static bool deleteAdvertisement(string id)
    {
        ...
        cmd.CommandText = "DELETE FROM admin_registeration.dbo.advertisement WHERE id = @id";

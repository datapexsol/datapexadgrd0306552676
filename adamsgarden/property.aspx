<%@ Page Title="" Language="C#" MasterPageFile="~/sitemaster.Master" AutoEventWireup="true" CodeBehind="property.aspx.cs" Inherits="masterpage.property" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div class="buy-single">
		...
		<div class="col-md-3 map-single-bottom">
			...
			<div class="single-box-right"><!-- feature aside --></div>
	  </div>
		<div class="clearfix"> </div>
		<div class="nav-page">
		<nav>

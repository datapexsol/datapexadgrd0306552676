    ...
    public class adminlogin
{
        ...
        public static bool login1(String username, string password)
        {
            ...
            String checkUser = "select count(*) from admin_registeration.dbo.admin_reg_db where username='" + username + "'";
            ...
            {
                conn.Open();
                String checkPassword = "select password from admin_registeration.dbo.admin_reg_db where username='" + username + "'";
            ...
            else
            {
                /* string q1 = "What was the last name of your third grade teacher";
                 ...
                 SqlCommand comand = new SqlCommand("insert into admin_registeration.dbo.security values(, @sec1,@sec2,@sec3)", conn);

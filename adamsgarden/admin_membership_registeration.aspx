...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <h2  class="downpayment" style="margin-left:0%;
           
            ">Registeration / Membership Fee Rs. 10,000</h2>
        ...
        <asp:Panel ID="addpanel" runat="server" Visible="true">
            ...
            <div class="form-group shortgroupdiv">
                <asp:Label ID="lbreg" runat="server" Text="Registeration no. :" for="tbreg"></asp:Label>
                ...
                <asp:TextBox ID="tbreg" runat="server"  class="form-control input-sm shorttb"></asp:TextBox>      
           </div> 
             ...
             <div class="form-group shortgroupdiv">
                ...
                <asp:TextBox ID="tbname" runat="server"  class="form-control input-sm shorttb"></asp:TextBox>      
           </div>    
            ...
            <div class="form-group shortgroupdiv">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator9" ControlToValidate="tbsof" runat="server" ErrorMessage="* Please Enter Father/Husband Name !"  SetFocusOnError="True" class="validationtxt"></asp:RequiredFieldValidator>
                  ...
                  <asp:TextBox ID="tbsof" runat="server"  class="form-control input-sm shorttb"></asp:TextBox>
            </div>
            ...
            <div class="form-group shortgroupdiv">
                <asp:Label ID="Label2" runat="server" Text="Postal Address" for="tbname"></asp:Label>
                 ...
                 <asp:TextBox ID="tbcurrentAddress" runat="server"  class="form-control input-sm shorttb"></asp:TextBox>
           </div>
           <div class="form-group shortgroupdiv">
                <asp:Label ID="Label3" runat="server" Text="Profession" for="tbname"></asp:Label>
                 ...
                 <asp:TextBox ID="tbprofession" runat="server"  class="form-control input-sm shorttb"></asp:TextBox>
           </div>
             <div class="form-group shortgroupdiv">
            ...
            <asp:TextBox ID="tbPhone" runat="server"  class="form-control input-sm shorttb"></asp:TextBox>
                 </div>
             <div class="form-group shortgroupdiv">
                <asp:Label ID="Label5" runat="server" Text="CNIC" for="tbcnic"></asp:Label>
                
              <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ControlToValidate="tbcnic" runat="server" ErrorMessage="*Please enter C.N.I.C"  SetFocusOnError="True" class="validationtxt"></asp:RequiredFieldValidator>
...
ErrorMessage="Enter correct format of CNIC xxxxx-xxxxxx-x" SetFocusOnError="True" class="validationtxt" ></asp:RegularExpressionValidator>
                ...
                <asp:TextBox ID="tbcnic" runat="server"  class="form-control input-sm shorttb"></asp:TextBox>
            ...
            <asp:TextBox ID="tbfavourof" runat="server"  class="form-control input-sm shorttb" Text="Adam's GARDEN (Pvt.) Ltd. " ReadOnly="true"></asp:TextBox>
                 </div>
             <div class="form-group shortgroupdiv">
                <asp:Label ID="Label8" runat="server" Text="JS Bank Account" for="tbname"></asp:Label>

            <asp:TextBox ID="tbjsbankaccout" runat="server" Text="0000760785" ReadOnly="true" class="form-control input-sm shorttb"></asp:TextBox>
                 </div>
            
            

             <div class="form-group shortgroupdiv">
                <asp:Label ID="Label10" runat="server" Text="Amount" for="tbname"></asp:Label>
            <asp:TextBox ID="tbamount" runat="server" Text="10000" ReadOnly="true" class="form-control input-sm shorttb"></asp:TextBox>
            </div>
             <div class="form-group shortgroupdiv">
                <asp:Label ID="Label11" runat="server" Text="Amount In Words" for="tbname"></asp:Label>
            <asp:TextBox ID="tbamountinwords" runat="server" Text="Ten Thousand" ReadOnly="true" class="form-control input-sm shorttb"></asp:TextBox>
                 </div>
             <div class="clear"></div>
            <asp:Button ID="add_db_btn" runat="server" Text="Save"  class="btn btn-primary btn-sm mybtnsm" OnClick="add_db_btn_Click" /> 

<%@ Page Title="" Language="C#" MasterPageFile="~/sitedashboardmaster.master" AutoEventWireup="true" CodeFile="~/admin_client_transfer.aspx.cs"
     Inherits="admin_transfer_form" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main" >
      <div class ="container">
        <div class="row">
            <h2 class="downpayment">Adam's Garden Transfer Form</h2>
             <div class="messagealert" id="alert_container">  </div>	
                ...
                <asp:TextBox ID="tbregno" runat="server" placeholder="Enter Registeration no." Font-Bold="True" AutoPostBack="True"></asp:TextBox>
...
-->
                        ...
                        <asp:Label ID="lbbuyername" runat="server" Text="ANITA RIASAT W/O PERVEZ SUNDHO" Font-Bold="true" Font-Size="Large"></asp:Label>
                        <br /><br />
                         <asp:Label ID="lbnic" runat="server" Text="NIC No. : " for="lbbuyernic"></asp:Label>
                        <asp:Label ID="lbbuyernic" runat="server" Text="12345-1234567-1" Font-Bold="true" Font-Size="Large" ></asp:Label>
                        <br /><br />
                <asp:Label ID="lbresidenceid" runat="server" Text="Residence of : " for="lbbuyeraddress"></asp:Label>
                        <asp:Label ID="lbbuyeraddress" runat="server" Text="h no.65" Font-Bold="true" Font-Size="Large"></asp:Label>
